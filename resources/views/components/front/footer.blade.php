	{{-- la page contact n'est presente que sur 3 pages :  HOME, Services, Contact --}}

	@if (request()->routeIs('front.index') || request()->routeIs('services.index') || request()->routeIs('contact.index'))
	...
	<footer class="footer-section">
		<h2>@php echo date('Y') @endphp -  {!! $footinfo->footer !!} <br/> {{-- <a href="http://www.dawit.eu">dawit.eu</a> --}}</h2>
	</footer>
	<!-- Footer section end -->
