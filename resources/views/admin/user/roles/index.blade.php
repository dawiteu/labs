            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <ul class="flex md:flex-row flex-col justify-center">
                        ...
                        <a href="{{route('role.index')}}" class=" m-2 p-1 rounded-sm"><li class="m-3 p-3 bg-green-600 hover:bg-green-400">Gestion rôles</li></a>
                ...
                @endWebmaster  
                    ...
                    <div class="w-full flex md:flex-row flex-col justify-center">
                        <div class="col m-1 w-full">
                            <form action="{{route('role.store')}}" method="POST" class="text-center">
                                @csrf
                            ...
                            <div class="flex flex-col">
                                @forelse ($roles as $role)
                                    <div class="m-1 bg-purple-200 flex justify-between">
                                        <p>{{$role->nom }} </p>
                                        <div class="flex"> 
                                            <p><a href="{{route('role.edit', $role)}}"><button class="bg-yellow-500 p-1 m-1  rounded" title="">M</button></a></p>
                                            <p><a href="{{route('role.destroy', $role)}}"><button class="bg-red-500 p-1 m-1  rounded" title="">X</button></a></p>
                                        </div>
                                    </div>
                                @empty
