                ...
                @endWebmaster  
                    ...
                    <div class="w-full flex md:flex-row flex-col justify-center">
                        <div class="col m-1 w-full">
                            <form action="{{route('admin.user.roleupdate', $role)}}" method="POST" class="text-center">
                                @csrf
                            ...
                            <div class="flex flex-col">
                                @forelse ($roles as $rol)
                                    <div class="m-1 bg-purple-200 flex justify-between">
                                        <p>{{$rol->nom }} </p>
                                        <div class="flex"> 
                                            <p><a href="{{route('admin.user.roleedit', $rol)}}"><button class="bg-yellow-500 p-1 m-1  rounded" title="">M</button></a></p>
