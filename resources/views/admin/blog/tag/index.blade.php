            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <ul class="flex md:flex-row flex-col justify-center">
                        ...
                        <a href="#"><li class="m-3 p-3 bg-green-600 hover:bg-green-400">Gérer TAGS </li></a>
                    ...
                    <div class="w-full flex md:flex-row flex-col justify-center">
                        <div class="col m-1 w-full">
                            <form action="{{route('admin.blog.tag.store')}}" method="POST" class="text-center">
                                @csrf
                            ...
                            <div class="flex flex-col">
                                @forelse ($tags as $tag)
                                    <div class="m-1 bg-purple-200 flex justify-between">
                                        <p>{{$tag->nom }} </p>
                                        <div class="flex"> 
                                            <p><a href="{{route('admin.blog.tag.edit', $tag)}}"><button class="bg-yellow-500 p-1 m-1  rounded" title="">M</button></a></p>
